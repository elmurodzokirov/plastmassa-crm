...
const COMPANY_PHONE = '+998 91 652 01 11';
...
export default function OrderCheckPage() {
  ...
  return (
    <>
      ...
      >
        {/* Title */}
        <p className="text-center text-sm font-bold text-black tracking-widest mb-3">
          HISOB-FAKTURA
        </p>

        {/* Top: Company Info (left) + Customer Info (right) */}
        <div className="flex justify-between items-start mb-5 pb-4 border-b-2 border-gray-800">
          <div>
            <h1 className="text-lg font-bold text-black tracking-wide">
              {COMPANY_NAME}
            </h1>
            <p className="text-xs text-gray-500 mt-0.5">{COMPANY_ADDRESS}</p>
            <p className="text-xs text-gray-500 mt-0.5">Tel: {COMPANY_PHONE}</p>
          ...
          <div className="text-right">
            <p className="text-xs text-gray-500 uppercase tracking-wider mb-1 font-semibold">Mijoz</p>
            <p className="text-base font-semibold text-black">{customerName}</p>
            {customerPhone && (
              <p className="text-xs text-gray-600 mt-0.5">Tel: {customerPhone}</p>
            )}
            {customerAddress && (
              <p className="text-xs text-gray-600 mt-0.5">Manzil: {customerAddress}</p>
            )}
          </div>
        </div>
